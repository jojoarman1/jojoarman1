...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    root = tree.getroot()
    justify_format(root, 'age_data', age_data, 56)
    justify_format(root, 'commit_data', commit_data, 25)
    justify_format(root, 'star_data', star_data, 20)
    justify_format(root, 'repo_data', repo_data, 8)
    justify_format(root, 'contrib_data', contrib_data)
    justify_format(root, 'follower_data', follower_data, 15)
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 4, 11))
    ...
    if False:  # archived-repos block only for original author # only calculate for user Andrew6rant
